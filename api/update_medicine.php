...
try {
    ...
    // Stock is managed only through medicine lots and cannot be edited here.
    $stmt = $pdo->prepare('UPDATE medicine SET medicine_name = :medicine_name, type_id = :type_id, price = :price WHERE medicine_id = :medicine_id');
    $stmt->execute([
